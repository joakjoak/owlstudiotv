...
export default FruitBoxPina;

function FruitBoxPinaInside() {
    ...
    <>
      ...
      <div className="container-core-pages">
        <div className="container-vid">
          {" "}
          <ReactPlayer
            url={"https://vimeo.com/317055448"}
            controls={true}
            width="100%"
            onReady={handleVideoReady} // Call handleVideoReady when video is ready
          />
        </div>
      </div>
      <div className="container-sep">
